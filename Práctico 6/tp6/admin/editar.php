	...
	<form action="editar_usuario.php" method="post">
		...
		<fieldset>
			...
			<ul>
				...
				<li><input type="text" name="nombre_usuario" value="<?php echo htmlentities($oUsuario->getNombre()); ?>"></li>
				
				<li><label>Contrase&ntilde;a:</label></li>
				<li><input type="password" name="contrasenia" value="<?php echo htmlentities($oUsuario->getContrasenia()); ?>"></li>
				...
				<li><input type="text" name="apellido" value="<?php echo htmlentities($oPersona->getApellido()); ?>"></li>
				
				<li><label>Nombre:</label></li>
				<li><input type="text" name="nombre" value="<?php echo htmlentities($oPersona->getNombre()); ?>"></li>
				...
				<li><input type="text" name="numero_documento" value="<?php echo htmlentities($oPersona->getNumeroDocumento()); ?>"></li>
				...
				<li><input type="text" name="nacionalidad" value="<?php echo htmlentities($oPersona->getNacionalidad()); ?>"></li>
			</ul>
		...
		<fieldset>
			...
			<ul>
				...
				<li><input type="text" name="email" value="<?php echo htmlentities($oPersona->getEmail()); ?>"></li>
				
				<li><label>Tel&eacute;fono:</label></li>
				<li><input type="text" name="telefono" value="<?php echo htmlentities($oPersona->getTelefono()); ?>"></li>
				
				<li><label>Celular:</label></li>
				<li><input type="text" name="celular" value="<?php echo htmlentities($oPersona->getCelular()); ?>"></li>
				
				<li><label>Domicilio:</label></li>
				<li><input type="text" name="domicilio" value="<?php echo htmlentities($oPersona->getDomicilio()); ?>"></li>
				...
				<li><input type="text" name="localidad" value="<?php echo htmlentities($oPersona->getLocalidad()); ?>"></li>
			</ul>
