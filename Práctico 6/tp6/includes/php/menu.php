<ul class="menu">
	...
	{
		echo "<li><a href='/tp6/admin/cerrar_sesion.php'>Cerrar Sesi&oacute;n</a></li>";
		echo "<li><a href='/tp6/admin/'>Inicio</a></li>";
	...
	{
		echo "<li><a href='/tp6/admin/'>Iniciar Sesi&oacute;n</a></li>";
	}
	?>
</ul>